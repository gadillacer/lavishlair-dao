...
const Banner = () => {
  ...
  return (
    <div className="p-8">
      ...
      <p>
        Current DAO Balance (from creator's royalty): <strong>{balance} Eth</strong> <br />
        Your SoulDrop reward this month :{' '}
        <span>
          <strong>{mybalance} Eth</strong>
        </span><br />
        Your Voting Power: <strong>{myVotingPower}</strong><br/><br/>
        <button
              type="button"
      ...
      <p>
        Hey, you must have SoulBound 🌰 to Raise/Vote a Proposal 😎
      </p>
      <div className="flex flex-row justify-start items-center md:w-1/3 w-full mt-4">
        <input
          ...
          placeholder="e.g: Azuki Collection veToken reward ENHANCEMENT"
