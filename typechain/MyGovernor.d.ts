...
interface MyGovernorInterface extends ethers.utils.Interface {
  functions: {
    ...
    "getExecutorAddress()": FunctionFragment;
    ...
    "setBoostedContract(address)": FunctionFragment;
    "setBoostingPercentage(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setBoostedContract",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "setBoostingPercentage",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  events: {
    "BoostingContractUpdated(address)": EventFragment;
    "BoostingPercentageUpdated(uint256)": EventFragment;
    "BoostingView(address,uint256,address,address,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "BoostingContractUpdated"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "BoostingPercentageUpdated"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "BoostingView"): EventFragment;
...
export type BoostingContractUpdatedEvent = TypedEvent<
  [string] & { tokenAddress: string }
>;

export type BoostingPercentageUpdatedEvent = TypedEvent<
  [BigNumber] & { percentage: BigNumber }
>;

export type BoostingViewEvent = TypedEvent<
...
export class MyGovernor extends BaseContract {
  ...
  functions: {
    ...
    getExecutorAddress(overrides?: CallOverrides): Promise<[string]>;
  ...
  filters: {
    "BoostingContractUpdated(address)"(
      tokenAddress?: string | null
    ): TypedEventFilter<[string], { tokenAddress: string }>;

    BoostingContractUpdated(
      tokenAddress?: string | null
    ): TypedEventFilter<[string], { tokenAddress: string }>;

    "BoostingPercentageUpdated(uint256)"(
      percentage?: BigNumberish | null
    ): TypedEventFilter<[BigNumber], { percentage: BigNumber }>;

    BoostingPercentageUpdated(
      percentage?: BigNumberish | null
    ): TypedEventFilter<[BigNumber], { percentage: BigNumber }>;

    "BoostingView(address,uint256,address,address,uint256)"(
      tokenAddress?: null,
      tokenId?: null,
      buyer?: null,
      seller?: null,
  ...
  estimateGas: {
    ...
    getExecutorAddress(overrides?: CallOverrides): Promise<BigNumber>;
